...
import { faBicycle, faDollar, faDollarSign, faEllipsisV } from '@fortawesome/free-solid-svg-icons';
...
const AVGrevenue = () => {
    return (
        <>
            <div className="box">
                <div className="avg-Revenue" style={{ display: 'flex', flexDirection: 'column' }}>
