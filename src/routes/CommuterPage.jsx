...
const CommuterPage = () => {
  ...
  const updateSelectCommuter = (id) => {
    setSelectedCommuter(id);
  };
  const updateSuspensionStatus = (suspensionStatus) => {
  ...
  const updateSearchValue = (searchValue) => {
    setsearchValueCommuter(searchValue);
  };
    ...
    <>
      <Container>
        ...
        <Row className="d-flex">
          <Col
            md={selectedCommuter === null ? 12 : 6}
            sm={12}
            xs={12}
            id="colContainerTable"
          >
            <CommuterTable
              selectUser={updateSelectCommuter}
              suspensionStatus={updateSuspensionStatus}
              searchValueCommuter={searchValueCommuter}
              onSelectCommuter={updateSelectCommuters}
