...
const RiderTable = () => {
    const data = [
        ...
        { id: 3, riderId: '789789', name: 'Larry Myersekerist', status: 'suspended' },
        { id: 4, riderId: '123123', name: 'Mark Zuckerberg', status: 'suspended' },
        { id: 5, riderId: '456456', name: 'Jacob Wikowski', status: 'active' },
        { id: 6, riderId: '789789', name: 'Larry Myersekerist', status: 'suspended' }
    ];
                    ...
                    <tbody>
                        {data.map((rider) => (
                            <tr key={rider.id}>
                                ...
                                <td>{rider.name}</td>
                                <td>
                                    <p className="status-circle" style={{
