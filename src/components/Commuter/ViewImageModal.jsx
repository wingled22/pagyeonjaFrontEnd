    ...
    return (
        <>
            <Modal isOpen={isOpen} toggle={untoggle} centered size='lg'>
                <ModalHeader toggle={untoggle} style={{backgroundColor: '#52459f', color: 'white'}}>Image Viewer</ModalHeader>
                <ModalBody>
                    {!imageSource && <center>No Image</center>}
                    {imageSource && <img src={dynamicImage} style={{ maxWidth: '100%' }} />}
                </ModalBody>
            </Modal>
        </>
    );
