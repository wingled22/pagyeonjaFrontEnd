      ...
      <div className="rect-profile">
        <Row>
          <Col style={{padding: "60px"}}md={3} lg={2} sm={3} xs={2} className="prof-col">
            {rider.profilePath === ""  || rider.profilePath === null || !rider.profilePath ? <Icon icon={faCircleUser} color='black' className="icon-img"></Icon> : <img className="profile-img" src={`http://localhost:5180/img/rider_profile/${rider.profilePath}`} alt="" />}
          </Col>

          <Col style={{padding: "20px"}} md={7} lg={8} sm={7} xs={10}>
            <Row className="name-row mt-5">
              <p className="text-ridername">{rider.firstName} {rider.middleName && rider.middleName[0]}. {rider.lastName}</p>
            </Row>
            <Row className="mt-2">
