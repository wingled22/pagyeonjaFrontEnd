          ...
          {rideHistoryData.map((item) => (
            <AccordionItem key={item.rideHistoryId}>
              ...
              >
                ...
                <Col md={4}>&emsp;|&emsp;{formatTime(item.endTime)}</Col>
              </AccordionHeader>
                  ...
                  <Col md={2}>
                    <span
                      className={`riderHistoryTextInfo ${
                        item.rate >= 1.0 && item.rate <= 2.9
                          ? "text-danger"
                          : item.rate >= 3.0 && item.rate <= 3.9
                          ? "text-warning"
                          : item.rate >= 4.0 && item.rate <= 5.0
                          ? "text-success"
                          : "text-danger"
                      }`}
                    >
                      ...
                      : &emsp;{" "}
                      <strong>
                        {item.rate ? parseFloat(item.rate).toFixed(1) : "N/A"}
                      </strong>
                    </span>
                  </Col>
                </Row>
